...
@Component({
  selector: 'app-routes-save',
  templateUrl: './routes-save.component.html',
  styleUrls: ['./routes-save.component.css']
})

export class RoutesSaveComponent implements OnInit {
 ...
 */
    ...
    function pathLoad() {
      ...
      that.router.navigate(['routes-load']);
    }
