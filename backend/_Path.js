...
class Path  {
  ...
  constructor(name, points) {
    ...
    this.params = pathData.parameters;
  ...
  analysePath() {
    ...
    let maxDist = 0;
    let bbox = { minLng: 180, maxLng: -180, minLat: 90, maxLat: -90};
     ...
     * Bounding box
     */
      bbox.minLat = point.lat < bbox.minLat ? point.lat : bbox.minLat;
      bbox.minLng = point.lng < bbox.minLng ? point.lng : bbox.minLng;
      bbox.maxLat = point.lat > bbox.maxLat ? point.lat : bbox.maxLat;
      bbox.maxLng = point.lng > bbox.maxLng ? point.lng : bbox.maxLng;
