...
const appRoutes: Routes = [
  ...
  { path: 'paths/:pathType', component: PathsComponent, canActivate: [AuthGuard]},
  { path: 'paths/:pathType/:id', component: PathsComponent, canActivate: [AuthGuard]},
  { path: 'paths/:pathType/:id/:pageType', component: PathsComponent, canActivate: [AuthGuard]},
